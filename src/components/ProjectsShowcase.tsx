              ...
              <div className="p-6 md:p-8 space-y-4">
                ...
                <div className="flex gap-4 pt-4">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-sm font-medium text-accent hover:text-text-bright transition-colors duration-200"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 text-sm font-medium text-text-muted hover:text-text-bright transition-colors duration-200"
                  >
                    <Github size={14} />
                    Source
                  </a>
