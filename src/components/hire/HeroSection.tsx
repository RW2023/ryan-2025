...
export default function HeroSection() {
    return (
        <motion.section
            ...
            className="text-center space-y-6 max-w-3xl mx-auto glass-card p-10"
        >
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold font-heading tracking-tight leading-snug text-accent flex flex-wrap items-center justify-center gap-2 sm:gap-3 text-center px-4">
                <motion.span
            ...
            <motion.p
                ...
                className="text-xl md:text-2xl text-text-muted max-w-2xl mx-auto"
            >
